...
export const createTable = (columnsArray, dataArray, tableId) => {
  if (
    ...
    throw new Error(
      "Para a correta execução, precisamos de um array com as colunas, outro com as informações das linhas e um id de tabela"
    );
  }
...
function createTableHeader(tableReference, columnsArray) {
  ...
  for (const tableColumnObject of columnsArray) {
    headerRow.innerHTML += `<th class="text-center">${tableColumnObject.columnLabel}</th>`;
  }
